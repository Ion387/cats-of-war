...
// Массив, создающийся заново при старте нового уровня в level.js и содержащий информацию о противниках. Каждый объет массива содежит всю информацию об отдельном виде противника.
let cats = [
];
